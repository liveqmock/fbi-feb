...
public class AcctabAction implements Serializable {
    ...
    public void onExpExcel() {
        ...
        try {
            ...
            fontColoer.setColor(HSSFColor.RED.index);           //负数红色
            ...
            //styleRight.setBorderBottom(HSSFCellStyle.BORDER_THkIN); //下
            HSSFCellStyle styleRightColoer = wb.createCellStyle();
            styleRightColoer.setAlignment(HSSFCellStyle.ALIGN_RIGHT);    //居右
