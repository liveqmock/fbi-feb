...
import gateway.sbs.txn.model.form.ac.T404;
import gateway.sbs.txn.model.form.ac.T814;
import gateway.sbs.txn.model.form.ac.T862;
...
public class ActapcAction implements Serializable {
    ...
    public String onAdd() {
        try {
            ...
            logger.error("核算码增加失败", e);
            MessageUtil.addError("核算码增加失败." + (e.getMessage() == null ? "" : e.getMessage()));
        }
        return null;
    }
