...
public class T531 extends SOFFormBody {

    {
        ...
        fieldLengths = new int[]{
                4, 39, 18, 4, 4, 4, 2, 8, 3, 16, 2, 22, 7, 30, 2, 2, 22, 7, 30, 2, 8, 4, 2, 2};
    }

    private String NBKMSG;       // 无折标志
