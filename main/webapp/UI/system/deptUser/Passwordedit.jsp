    ...
    <script language="javascript">
        ...
        function SaveClick() {
            if (checkForm(editdept) == "false")
                return;
            if (document.all.newpwd.value.length != 8) {
                alert("请输入8位新密码！");
            ...
            if (document.all.newpwd.value == document.all.checkpwd.value) {
                ...
                var fieldNode = createFieldNode(xmlDoc, "checkpwd", "text", document.all.checkpwd.value);
                RecorderNode.appendChild(fieldNode);
    ...
    <fieldset>
        ...
        <table align="center" valign="center">
            <tr>
                ...
                <td class="data_input">
                    <input id="operID" disabled="true" fieldName="operid" textLength="50" fieldType="text" type="text"
                           value="<%=operID%>">
                </td>
            </tr>
            <tr>
                ...
                <td class="data_input">
                    <input id="oldpwd" fieldName="oldpwd" fieldType="text" isNull=false type="password">
                </td>
            </tr>
